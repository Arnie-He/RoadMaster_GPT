...
def get_prompt_features():
    prompt = read_file('/Users/kevin/Desktop/cs1470/final_project/prompt/prompt.txt')
    preprocess_captions([[prompt]], 100)
    embedding = tf.keras.layers.Embedding(1, 256)
    feature = embedding(np.array(prompt))
    return feature
...
def load_data(data_folder):
    ...
    for example in examples:
        ...
        image_names_to_captions[img_name] = [caption]
    ...
    def get_all_captions(image_names):
        ...
        for image in image_names:
            caption = image_names_to_captions[image]
...
if __name__ == '__main__':
    ...
    data_folder = '/Users/kevin/Desktop/cs1470/final_project/prompt/data'
